...
# to use DecisionTreeClassifier or RandomForestClassifier
useDecisionTreeClassifier = False
...
my_classifier = tree.DecisionTreeClassifier() if useDecisionTreeClassifier  else ensemble.RandomForestClassifier()
